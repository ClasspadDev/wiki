...
:::tip[Need help ?]
You can either ask help to the [👨‍💻 PythonExtra ChatGPT](https://chatgpt.com/g/g-67fb8fb50e2c8191a7df1b814ad8fce9-pythonextra-helper) or go retro and ask [💬 some human on the ClassPad Club](https://discord.gg/knpcNJTzpd).
:::
