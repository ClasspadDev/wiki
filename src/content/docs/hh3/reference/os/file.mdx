...
:::tip[Need code ?]
You can jump right to the [👨‍💻 Usage](#usage) or refer to the [original SDK Code](https://github.com/ClasspadDev/hollyhock-3/blob/master/sdk/include/sdk/os/file.h) if you need more details.
:::
