...
:::tip[Note]
You will need a compatible 3-pin serial (2.5mm jack) adapter and another device (like an Arduino, Raspberry Pi, or PC with a serial port) to communicate. Check the [Comunication with Serial](#) guide for more informations. 
:::
