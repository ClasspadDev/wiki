...
Make sure you have completed the [Hello World tutorial](/wiki/examples/hello-world/) before proceeding. Your `main.cpp` file should look similar to the final code from that tutorial.
